...
EXAMPLES: Dict[str, Dict[str, Any]] = {
    ...
    "realtime-api": {
        "desc": "Realtime API monitoring recipes: ws/wss/grpc + http",
        "quick": 'from toonic.server.quick import watch\nwatch("ws://localhost:8080/stream", "grpc://localhost:50051", "https://httpbin.org/get")',
        "preset": None,
        "sources": [
    ...
    "db-archive-triage": {
        "desc": "Database DSNs + extracted archive directory triage recipes",
        "quick": 'from toonic.server.quick import watch\nwatch("postgresql://user:pass@db:5432/app", "redis://cache:6379", "dir:./examples/")',
        "preset": None,
        "sources": [
            "postgresql://user:pass@db:5432/app",
    ...
    "infra-triage": {
        "desc": "Infra triage bundle: docker + network + process + directory + logs",
        "quick": 'from toonic.server.quick import run\nrun("docker:*", "net:8.8.8.8", "proc:nginx", "dir:./examples/", goal="infra triage")',
        "preset": None,
        "sources": [
            "docker:*",
            "net:8.8.8.8,1.1.1.1",
